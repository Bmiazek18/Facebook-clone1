...
<template>
  ...
  <BaseModal
    ...
    title="Odrzucić relację?"
    @close="showDiscardConfirm = false"
  >
    <div class="p-6 text-theme-text max-w-md w-full bg-theme-bg-secondary rounded-lg">
      <p class="mb-6 text-[15px] text-theme-text-secondary leading-normal">
        Czy na pewno chcesz odrzucić tę relację? Twoje zmiany nie zostaną zapisane.
      </p>
