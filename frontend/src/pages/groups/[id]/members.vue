...
<template>
  <div class="min-h-screen bg-transparent p-4 flex justify-center">
    ...
    <div class="w-full max-w-[680px] bg-theme-bg-secondary rounded-lg shadow-sm p-4">
      ...
      <section class="mb-4">
        ...
        <div class="relative flex items-center bg-theme-bg dark:bg-[#3A3B3C] rounded-full px-3 py-2">
          <svg class="w-[18px] h-[18px] text-theme-text-secondary dark:text-[#B0B3B8] ml-1" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div v-if="isLoading">
        <hr class="my-4 border-theme-border dark:border-[#3E4042]" />

        <!-- Skeleton: Administratorzy -->
        <section class="mb-4">
          <div class="flex items-center mb-5">
            <div class="h-[20px] w-48 bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded animate-pulse"></div>
          </div>
          ...
          <div class="space-y-4">
            ...
            <div v-for="i in 2" :key="'admin-skel-'+i" class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                <div class="w-[60px] h-[60px] rounded-full bg-theme-bg-tertiary dark:bg-[#3A3B3C] animate-pulse flex-shrink-0"></div>
                <div class="flex flex-col gap-2.5 w-32 md:w-48">
                  <div class="h-3.5 bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded animate-pulse w-3/4"></div>
                  <div class="h-4 bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded animate-pulse w-24"></div>
                  <div class="h-3 bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded animate-pulse w-full"></div>
                </div>
              </div>
              <div class="w-[140px] h-[36px] bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded-md animate-pulse hidden sm:block"></div>
            </div>
          </div>

          <div class="w-full mt-4 h-9 bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded-md animate-pulse"></div>
        </section>
        ...
        <section>
          <div class="mb-5">
            <div class="h-[20px] w-40 bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded animate-pulse mb-3"></div>
            <div class="h-3 w-full max-w-md bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded animate-pulse mb-2"></div>
            <div class="h-3 w-5/6 max-w-sm bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded animate-pulse"></div>
          </div>
          ...
          <div class="space-y-4">
            ...
            <div v-for="i in 3" :key="'member-skel-'+i" class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                <div class="w-[60px] h-[60px] rounded-full bg-theme-bg-tertiary dark:bg-[#3A3B3C] animate-pulse flex-shrink-0"></div>
                <div class="flex flex-col gap-2.5 w-32 md:w-48">
                  <div class="h-3.5 bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded animate-pulse w-4/5"></div>
                  <div class="h-3 bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded animate-pulse w-3/5"></div>
                </div>
              </div>
              <div class="w-[120px] h-[36px] bg-theme-bg-tertiary dark:bg-[#3A3B3C] rounded-md animate-pulse hidden sm:block"></div>
            </div>
          </div>
            ...
            <div v-for="admin in admins" :key="admin.id" class="flex items-center justify-between">
              ...
              <div v-if="admin.id !== authStore.currentUserId" class="flex items-center gap-2">
                ...
                <button
                  ...
                  class="bg-theme-bg-tertiary dark:bg-[#3A3B3C] hover:bg-theme-hover-strong dark:hover:bg-[#4E4F50] text-theme-text dark:text-[#E4E6EB] px-3 py-1.5 rounded-md font-semibold text-[15px] transition flex items-center gap-1.5 cursor-pointer"
                >
                  <svg class="w-4 h-4 fill-currentColor" viewBox="0 0 24 24">
