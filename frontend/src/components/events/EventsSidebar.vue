    ...
    <template v-if="!not" #pre-list>
      ...
      <div class="space-y-2">
        <div
          ...
          :key="event.id"
          class="flex gap-3 p-2 hover:bg-theme-hover rounded-xl cursor-pointer transition group"
        >
      ...
      <div class="space-y-2">
        <div
          ...
          :key="event.id"
          class="flex gap-3 p-2 hover:bg-theme-hover rounded-xl cursor-pointer transition"
        >
          <img :src="event.img" class="w-[60px] h-[60px] rounded-xl object-cover" />
          <div class="flex flex-col min-w-0">
    ...
    <template #list-items>
      <div class="space-y-1">
        <div
          ...
          :key="cat.name"
          class="flex items-center gap-3 hover:bg-theme-hover px-3 py-2 rounded-lg cursor-pointer transition group"
        >
