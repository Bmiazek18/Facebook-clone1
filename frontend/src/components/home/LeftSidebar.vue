...
<template>
  ...
  >
    <HoverScrollbar class="flex-1">
      <div class="pr-2">
        <a
          class="flex items-center justify-start w-full cursor-pointer hover:bg-theme-hover p-2 rounded-lg transition-colors mb-2"
        >
          <img
        ...
        <div class="space-y-1">
          ...
          >
            <div
              v-if="item.isGradient"
              class="flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-tr from-blue-400 to-purple-500"
            >
          ...
          >
            <div class="flex items-center justify-center w-9 h-9 rounded-full bg-theme-bg-tertiary">
              <component
                :is="showMoreMenu ? ChevronUp : ChevronDown"
                :size="24"
        ...
        <div class="px-2 pb-4">
          ...
          <div class="space-y-1">
            ...
            >
              <div
                class="flex items-center justify-center w-9 h-9 rounded-full bg-theme-bg-tertiary"
              >
                <component
                  :is="showMoreShortcuts ? ChevronUp : ChevronDown"
                  :size="24"
                  class="text-theme-text"
                />
              </div>
