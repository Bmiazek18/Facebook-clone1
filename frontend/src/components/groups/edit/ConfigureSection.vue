  ...
  <div class="bg-theme-bg-secondary rounded-xl p-4 shadow-sm border border-theme-border">
    ...
    <div class="flex flex-col">
      <template v-for="item in items" :key="item.id">
        ...
        >
          <h3 class="text-[15px] font-semibold text-theme-text mb-3">
            {{ item.label }}
          </h3>
          ...
          <div class="space-y-3">
            ...
            <div class="relative border border-theme-border rounded-xl px-3 py-2 focus-within:border-[#1877f2] dark:focus-within:border-[#4599ff] focus-within:ring-1 focus-within:ring-[#1877f2] dark:focus-within:ring-[#4599ff] transition-all">
              ...
              <input
                v-model="formName"
                type="text"
                class="w-full bg-transparent text-[15px] text-theme-text font-semibold focus:outline-none mt-0.5"
              />
            </div>
        ...
        <div
          ...
          class="py-3 border-b border-theme-border last:border-0"
        >
          <div class="flex items-center justify-between mb-2 cursor-pointer" @click="cancelEdit">
            <h3 class="text-[17px] font-bold text-theme-text">
              {{ item.label }}
            </h3>
        ...
        >
          ...
          <div class="relative w-full h-44 rounded-xl overflow-hidden bg-[#87ceeb] mb-3 border border-gray-200 dark:border-[#525355]">
            ...
            <button class="absolute right-2 bottom-2 bg-white/80 dark:bg-black/60 rounded-full p-1 text-theme-text">
              <InformationOutlineIcon :size="18" />
            </button>
          </div>

          <div class="relative border border-theme-border rounded-xl px-3 py-3 focus-within:border-[#1877f2] dark:focus-within:border-[#4599ff] focus-within:ring-1 focus-within:ring-[#1877f2] dark:focus-within:ring-[#4599ff] transition-all">
            <input
