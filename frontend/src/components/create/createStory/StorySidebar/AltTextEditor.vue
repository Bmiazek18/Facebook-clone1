<template>
  <div class="px-4 py-4">
    ...
    >
      ...
      <div
        class="w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0 transition mt-0.5"
        :class="
          selectedOption === 'auto'
            ? 'border-blue-600'
    ...
    <div class="flex items-start gap-2 mt-2">
      ...
      <div
        ...
        :class="
          selectedOption === 'custom' ? 'border-blue-600' : 'border-gray-300 hover:border-gray-400'
        "
