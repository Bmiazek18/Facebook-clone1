  ...
  <div class="flex flex-col mt-2 pb-4 px-4">
    <div class="relative mb-4">
      <div
        ...
        class="border border-theme-border rounded-md p-3 flex justify-between items-center cursor-pointer hover:bg-theme-hover transition"
      >
        ...
        <ChevronDown
          :size="20"
          class="text-theme-text-secondary transition-transform"
          :class="{ 'rotate-180': isFontMenuOpen }"
        />
      </div>

      <div
        v-if="isFontMenuOpen"
        class="absolute top-full left-0 w-full mt-1 bg-theme-bg-secondary border border-theme-border rounded-md shadow-lg z-30 overflow-hidden"
      >
        <ul>
          <li
            ...
            class="px-4 py-3 hover:bg-theme-hover cursor-pointer flex items-center justify-between group border-b border-theme-border last:border-0"
          >
            <span :class="font.class" class="text-xl text-theme-text scale-90 origin-left">{{
              font.label
            }}</span>
      ...
      <div class="flex flex-wrap gap-2.5">
        ...
        >
          <button
            ...
            :class="[
              'w-9 h-9 rounded-full cursor-pointer shadow-sm border border-black/10 hover:opacity-80 transition block',
              bg.class,
            ]"
            :title="bg.name"
          ></button>
        ...
        <button
          ...
          class="w-10 h-10 flex items-center justify-center bg-theme-bg-secondary rounded-full hover:bg-theme-hover-strong transition text-theme-text-secondary ml-1 shrink-0"
    ...
    <div
      ...
      class="flex items-center gap-4 py-3 hover:bg-theme-hover cursor-pointer transition rounded-md"
      :class="{ 'bg-blue-50 border-l-4 border-blue-500': isMusicModalOpen }"
    >
