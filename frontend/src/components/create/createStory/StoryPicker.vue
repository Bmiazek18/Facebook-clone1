...
<template>
  <div class="flex h-screen w-full bg-theme-bg  ">
    <StorySidebar
      :is-music-modal-open="false"
      :current-alt-text="''"
    ...
    <main class="flex-1 flex items-center justify-center p-8 relative">
      <div class="flex gap-6">
        ...
        >
          <div
            class="absolute inset-0 bg-linear-to-b from-[#56C3F8] via-[#488AD4] to-[#2F5C96]"
          ></div>
        ...
        >
          <div
            class="absolute inset-0 bg-linear-to-b from-[#AA50E1] via-[#B9449C] to-[#E94E5A]"
          ></div>
          <div class="relative z-10 flex flex-col items-center justify-center h-full gap-4">
            <div class="bg-white p-3 rounded-full shadow-md">
