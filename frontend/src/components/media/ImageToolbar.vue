...
<template>
  <div
    class="absolute bottom-8 left-1/2 -translate-x-1/2 bg-black/80 backdrop-blur-md px-6 py-3 rounded-full shadow-2xl flex items-center gap-6 z-[200] border border-white/10 animate-fade-in"
  >
