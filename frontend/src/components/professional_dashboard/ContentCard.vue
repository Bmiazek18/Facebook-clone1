...
<template>
  <div class="bg-white rounded-[8px] shadow-sm p-4 flex flex-col">
    ...
    <div class="flex justify-between items-start mb-10">
      <div>
        <h2 class="text-[20px] font-bold text-[#050505] leading-tight">Materiały</h2>
        <p class="text-[13px] text-[#65676B] mt-1">Uzyskuj dostęp do opublikowanych i zaplanowanych postów oraz twórz nowe materiały w jednym miejscu.</p>
      </div>
      <a href="#" class="text-[#1877F2] text-[15px] font-semibold hover:underline shrink-0">Wyświetl wszystko</a>
    </div>
    ...
    <div v-if="!hasMaterials" class="flex flex-col items-center justify-center mb-8">
      ...
      <h3 class="text-[17px] font-bold text-[#050505] mb-1">Nie masz jeszcze żadnych materiałów</h3>
      <p class="text-[15px] text-[#65676B] mb-4 text-center">Zacznij tworzyć, aby dodać zawartość do biblioteki.</p>
    ...
    <div v-else class="flex flex-col md:flex-row gap-4 mb-10">
      ...
      <div class="shrink-0 p-1 bg-white border border-gray-100 shadow-[0_2px_8px_rgba(0,0,0,0.08)] rounded-2xl w-[140px] h-[140px]">
        <div class="w-full h-full rounded-xl bg-gradient-to-b from-[#8E9399] to-[#55595E] p-3 flex flex-col">
          <span class="text-white font-bold text-[18px] leading-none">Aa</span>
        </div>
      </div>
      ...
      <div class="flex-1 flex flex-col gap-3">
        ...
        <div class="bg-[#F7F8FA] rounded-xl p-4 flex flex-col justify-center">
          ...
          <div class="flex items-center gap-1.5 text-[14px] text-gray-700">
            Wyświetlenia
    ...
    <div class="flex justify-between items-center mb-4">
      <h2 class="text-[20px] font-bold text-[#050505]">Zaplanowana zawartość</h2>
    ...
    <div class="grid grid-cols-4 rounded-lg overflow-hidden min-h-[180px]">
      ...
      <div class="border-r border-[#CED0D4] p-2 flex flex-col items-center justify-center bg-[#F0F2F5] text-center relative pb-4 pt-8">
        ...
        <div class="font-bold text-[14px] text-[#050505] leading-tight mb-1">Brak postów dzisiaj</div>
        <div class="text-[12px] text-[#65676B] leading-tight px-1">Utrzymuj zainteresowanie odbiorców poprzez regularne publikowanie materiałów.</div>
      </div>
      <!-- Day 2 -->
