...
<template>
  <div
    id="MainNav"
    class="fixed z-1 w-full flex items-center justify-between top-0 h-14 bg-white shadow-md"
  >
    <div id="NavLeft" class="flex items-center justify-start w-[260px]">
      ...
      <div class="flex items-center justify-center bg-[#EFF2F5] p-1 rounded-full h-10 ml-2">
    ...
    >
    <div class="border-b-4 border-b-blue-400 flex items-center justify-center h-12 p-1  w-full mx-1 cursor-pointer">
      <button
        class=" rounded-lg "
      >
      ...
      <button
        class="flex items-center justify-center h-12 p-1 hover:bg-[#F2F2F2] w-full rounded-lg mx-1 cursor-pointer"
      >
    ...
    <div class="flex items-center justify-end w-[260px] mr-4 relative">
      ...
      <button @click="toggleMenu('message')" class="rounded-full bg-[#E3E6EA] p-2 hover:bg-gray-300 mx-1 cursor-pointer">
        <FacebookMessenger :size="23" fillColor="#050505" />
      </button>

      <button @click="toggleMenu('notifications')" class="rounded-full bg-[#E3E6EA] p-2 hover:bg-gray-300 mx-1 cursor-pointer">
      ...
      <div
        ...
        class="absolute bg-white top-[40px] right-0 w-auto rounded-lg p-1  mt-1"
      >
