<template>
  <div :class="['flex items-center gap-3 transition pl-4 pt-2', { 'slide-in': !hasAnimatedOnce }]">
          <button
            @click="goBack"
      ...
      class="w-11 h-11 bg-[#1877F2] rounded-full flex items-center justify-center text-white"
    >
      <Facebook :size="28" />
    </div>
  </div>
