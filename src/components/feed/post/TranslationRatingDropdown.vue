        ...
        <div class="mt-2">
          <button class="w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-start gap-3 transition-colors">
            ...
            <div class="flex flex-col">
              <span class="font-medium leading-tight">Nigdy nie tłumacz z języka: {{ detectedLanguage }}</span>
              <span class="text-[13px] text-gray-500 mt-0.5">Tłumaczenie z języka: {{ detectedLanguage }} na polski</span>
            </div>
          </button>
          ...
          <button class="w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-start gap-3 transition-colors">
            ...
            <div class="flex flex-col">
              <span class="font-medium leading-tight">Post nie był w języku: {{ detectedLanguage }}</span>
