...
<template>
  <aside class="w-[360px] shrink-0 bg-theme-bg-secondary shadow-xl flex flex-col h-full z-20 hidden md:flex border-r border-gray-200 dark:border-gray-700">
    ...
    <AppCloseHeader class="mt-3 pl-3 pb-3 border-b-1 border-b-theme-border  "/>
    <div class="pt-2 px-4 pb-2">

      <h1 class="text-2xl font-semibold text-black dark:text-gray-200 tracking-tight">{{ t('story.stories') }}</h1>
