...
<template>
  ...
  >
    <div class="absolute inset-0 pointer-events-none opacity-80">
      <div class="absolute top-20 left-10 w-24 h-32 bg-green-400 rounded-[50%] rotate-[-15deg] shadow-lg animate-float-slow opacity-90"></div>
      <div class="absolute top-40 right-10 w-28 h-36 bg-blue-500 rounded-[50%] rotate-[10deg] shadow-xl animate-float-fast"></div>
...
.animate-float-slow { animation: float 6s ease-in-out infinite; --r: -5deg; }
.animate-float-medium { animation: float 5s ease-in-out infinite; animation-delay: 1s; --r: 5deg; }
.animate-float-fast { animation: float 4s ease-in-out infinite; animation-delay: 2s; --r: 10deg; }
