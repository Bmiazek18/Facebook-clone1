...
<template>
  <div class=" bg-theme-bg-secondary text-theme-text p-6 mt-4 font-sans">

    <div class="flex justify-between items-center mb-6">
      <h1 class="text-xl font-bold">Multimedia</h1>
      <div class="flex space-x-6 text-sm">
        <RouterLink to="/addAlbum" class="text-theme-primary hover:text-theme-primary-hover transition flex items-center font-medium">
