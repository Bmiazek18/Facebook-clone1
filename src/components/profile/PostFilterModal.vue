<template>
    ...
    <div class="theme-bg shadow-lg w-full max-w-[540px] p-4 font-sans text-gray-900">
      ...
      <div class="space-y-3 mb-6">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="w-[180px]">
            <CustomDropdown v-model="filters.year" :options="yearOptions" :label="t('postFilter.yearLabel')" />
          </div>
        </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="w-[180px]">
            <CustomDropdown v-model="filters.postedBy" :options="postedByOptions" :label="t('postFilter.postedByLabel')" />
          </div>
        </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="w-[180px]">
            <CustomDropdown v-model="filters.privacy" :options="privacyOptions" :label="t('postFilter.privacyLabel')" />
          </div>
        </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="w-[180px]">
            <CustomDropdown v-model="filters.tagged" :options="taggedOptions" :label="t('postFilter.taggedLabel')" />
          </div>
        </div>
