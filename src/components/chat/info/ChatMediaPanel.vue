<template>
  <div class="h-full flex flex-col bg-white">
    ...
    <div class="flex border-b border-gray-200 px-4">
      <button
        class="px-4 py-3 font-semibold text-[14px] text-blue-600 border-b-[3px] border-blue-600"
      >
        Multimedia
      </button>
      <button
        class="px-4 py-3 font-semibold text-[14px] text-gray-500 hover:bg-gray-50 rounded-t-md transition ml-2"
      >
        Pliki
      </button>
    </div>
