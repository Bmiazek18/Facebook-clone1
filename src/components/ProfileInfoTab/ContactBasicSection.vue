  ...
  <div class="space-y-8 text-base">
    ...
    <div>
      ...
      <div class="space-y-6">
         ...
         <div class="flex justify-between items-center">
            <div class="flex items-center text-gray-900 ml-[2.6rem]"> <div>
                   <div class="font-semibold text-lg">2005</div>
                   <div class="text-xs text-gray-500">Rok urodzenia</div>
               </div>
            </div>
            <div class="flex items-center space-x-3 text-gray-500 pr-[3.25rem]"> <AccountMultiple class="text-lg text-gray-400"/>
            </div>
         </div>
