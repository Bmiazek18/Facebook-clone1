...
<template>
  <aside class="w-full lg:w-[360px] bg-theme-bg-secondary h-full flex flex-col relative z-20 shadow-xl shrink-0 font-sans">
   ...
   <AppCloseHeader/>
      ...
      <div class="flex items-center justify-between px-4 pb-4 pt-2 " >
        ...
        <button class="bg-gray-200/50 p-2 rounded-full cursor-pointer hover:bg-gray-200 transition-colors flex items-center justify-center">
    ...
    <div v-if="mode !== undefined" class="p-4 flex gap-3 bg-theme-bg-secondary z-30 border-t border-gray-100 " >
      <button
        @click="emit('back')"
        class="flex-1 py-2.5 rounded-lg bg-gray-200 text-black font-semibold hover:bg-gray-300 transition-colors text-[15px]"
      >
        Odrzuć
      </button>
      ...
      <button
        ...
        class="flex-1 py-2.5 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-colors shadow-sm text-[15px]"
      >
