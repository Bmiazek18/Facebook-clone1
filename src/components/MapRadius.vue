...
const center: [number, number] = [52.059, 19.199]; // Łęczyca
...
onMounted(() => {
  ...
  L.marker(center, { icon: redIcon }).addTo(map);
...
const apply = () => {
  emit('apply', radiusKm.value);
  console.log('Wybrano promień:', radiusKm.value);
};
</script>

<template>
  <div class="w-full mx-auto bg-white font-sans text-gray-800 min-h-[600px]">

    <div class="space-y-4 p-4 relative">

      <div class="flex items-center border border-gray-300 rounded-xl px-4 py-2.5 shadow-sm bg-white">
        ...
        <div class="flex flex-col">
          <span class="text-xs text-gray-500 font-normal">Lokalizacja</span>
          <span class="text-base font-medium text-gray-900 leading-tight">Łęczyca gmina</span>
        </div>
      </div>
      ...
      <div ref="dropdownRef" class="relative">
        ...
        <div
          ...
          :class="isDropdownOpen ? 'border-blue-600 ring-1 ring-blue-600' : 'border-gray-300 hover:border-gray-400'"
        >
          <div class="flex flex-col">
          ...
          <div class="text-gray-600 transition-transform duration-200" :class="{ 'rotate-180': isDropdownOpen }">
      ...
      <div class="relative mt-4 z-0">
        <div ref="mapContainer" class="w-full h-[400px] rounded-2xl border border-gray-200 overflow-hidden"></div>
      </div>
