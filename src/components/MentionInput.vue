    ...
    <div class="relative w-full">
        ...
        >
            <div
                ...
                :class="inputClass || 'w-full bg-transparent border-none outline-none focus:ring-0 p-0 text-[15px] text-[#050505] resize-none overflow-hidden min-h-[22px] leading-relaxed whitespace-pre-wrap'"
            ></div>
            <template #popper>
