...
<template>
  <Transition name="pop">
    <div
      v-if="isOpen"
      class="absolute -right-[115px] top-15 w-[320px] bg-white rounded-xl shadow-2xl z-300 flex flex-col h-[500px] overflow-hidden border border-gray-200"
    >
      ...
      <div class="flex-1 overflow-y-auto custom-scrollbar">
        <div class="px-2 py-2">
          ...
          <div
            ...
            :key="track.id"
            class="group flex items-center justify-between py-2 px-2 hover:bg-gray-100 rounded-lg transition cursor-pointer"
          ...
          >
            ...
            <div class="flex items-center gap-1">
              <button
                ...
                class="p-1 text-gray-400 hover:text-blue-600 rounded-full hover:bg-blue-50 transition"
