...
<template>
    ...
    <div class="bg-white w-full max-w-[600px] rounded-lg shadow-lg relative overflow-hidden">
      ...
      <button @click="emit('close')" class="absolute top-4 right-4 bg-gray-200 hover:bg-gray-300 rounded-full p-2 z-10 transition">
      ...
      <div class="p-4 pt-10">
        ...
        <div class="flex flex-col items-center text-center mb-6">
          <div class="relative mb-4">
            <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-sm bg-gray-200">
          ...
          <button class="w-full bg-[#E4E6EB] hover:bg-[#D8DADF] text-gray-400 font-semibold py-2 px-4 rounded-md flex items-center justify-center transition cursor-not-allowed">
        ...
        <div class="mb-4">
          ...
          <p class="text-xs text-gray-500 mt-1">
            (Widoczne publicznie po 5 ocenach. <span class="font-semibold cursor-pointer hover:underline">Dowiedz się więcej</span>)
          </p>
        </div>
        ...
        <div>
          ...
          <p class="text-xs text-gray-500 mb-4 leading-snug">
            Ogłoszeniami możesz zarządzać na stronie <a href="#" class="text-blue-500 hover:underline">Twoje ogłoszenia</a>. Ogłoszenia w grupach prywatnych mogą nie...
          </p>
          ...
          <div class="flex flex-col sm:flex-row gap-2 mb-8">
            ...
            <button class="bg-[#E4E6EB] hover:bg-[#D8DADF] text-black font-semibold py-2 px-3 rounded-md text-sm flex items-center justify-between whitespace-nowrap">
