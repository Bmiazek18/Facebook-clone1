<template>
  <div class="bg-white dark:bg-theme-bg-secondary rounded-2xl border border-gray-100 dark:border-theme-border w-full max-w-lg mx-auto overflow-hidden">
    ...
    <div class="p-4 space-y-3">
      ...
      <div class="flex gap-2 pt-2">
        ...
        <button class="flex-shrink-0 w-12 flex items-center justify-center bg-gray-200 dark:bg-theme-bg-tertiary text-gray-800 dark:text-theme-text rounded-xl hover:bg-gray-300 dark:hover:bg-theme-bg-hover transition-colors">
...
const question = ref(createPostStore.poll?.question || '');
const options = ref(createPostStore.poll?.options && createPostStore.poll.options.length > 0
  ? createPostStore.poll.options
  : [{ text: '' }, { text: '' }]
);
