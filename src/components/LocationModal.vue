<template>
  <div
    class="bg-white w-full h-[90vh] sm:max-w-[800px] sm:h-[650px] sm:rounded-xl shadow-2xl flex flex-col overflow-hidden relative animate-in slide-in-from-bottom-10 duration-300"
  >
    <div class="p-3 border-b border-gray-200 shrink-0 bg-white z-20 relative">
      <div
        class="bg-[#f0f2f5] rounded-full flex items-center px-3 py-2.5 border border-transparent focus-within:border-[#1877f2] transition-colors group"
      >
    ...
    <div class="flex-1 relative bg-[#e4e6eb] w-full h-full overflow-hidden">
      ...
      <div
        v-if="isLoadingMap"
        class="absolute inset-0 bg-white/60 z-500 flex items-center justify-center backdrop-blur-[2px]"
      >
        <div
          class="animate-spin rounded-full h-10 w-10 border-[3px] border-gray-200 border-t-[#1877f2]"
        ></div>
      </div>
    </div>

    <div
      class="p-4 bg-white border-t border-gray-200 shrink-0 z-20 relative shadow-[0_-4px_12px_rgba(0,0,0,0.05)]"
    >
