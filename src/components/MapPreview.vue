...
<template>
  <div
    v-if="props.selectedLocation"
    class="relative mb-4 border border-gray-300 rounded-xl overflow-hidden shadow-sm bg-gray-100"
  >
    <div
      @click="$emit('removeLocation')"
      class="absolute top-2 right-2 z-99999 bg-white w-8 h-8 rounded-full flex items-center justify-center cursor-pointer shadow-md hover:bg-gray-100 transition"
    >
    ...
    <div class="bg-[#f0f2f5] p-3 flex items-center border-t border-gray-200">
      <div
        class="w-10 h-10 rounded-full bg-[#f3425f] flex items-center justify-center shrink-0 text-white mr-3"
      >
